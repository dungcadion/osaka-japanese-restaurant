...
const HomeSection = () => (
  ...
  >
    ...
    <div className="relative z-10 p-4 flex flex-col items-center w-3/4 max-w-lg">
      ...
      />
      <p className="w-full mt-1 text-base md:text-lg lg:text-xl font-semibold text-black mx-auto [text-shadow:0_2px_4px_rgba(255,255,255,0.9)]">
...
const AboutSection = () => (
  <section
    ...
    style={{ background: BG_WHITE, color: TEXT_COLOR }}
  >
      ...
      <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
        ...
        <div className="md:w-1/2 w-full">
          ...
          <p className="mb-4 text-lg leading-relaxed">
            Step into Osaka Japanese Restaurant for a light and relaxing dining
            experience. We offer a wide range of authentic Japanese cuisine,
            featuring traditional ramen like Tonkotsu and Shoyu Ramen, as well
            as creamy and spicy Tantanmen. Our menu also includes Japanese
            curries such as Beef Curry and Katsu Curry, served over steamed
            rice. Sushi and sashimi lovers can enjoy classic options like fresh
            salmon and tuna, along with premium choices such as Aburi Salmon and
            Uni. Our specialty maki rolls include the popular California Maki
            and unique creations like the Osaka Tower. We also serve premium A5
            Wagyu and Saikoro Steak. To complement your meal, we offer Sapporo
            Premium Beer and Sapporo Premium Black.
          </p>
        </div>
      </div>
    </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
          ...
          <div className="md:w-1/2 w-full text-center md:text-left">
            ...
            <p className="text-lg text-gray-600 my-6 max-w-xl mx-auto md:mx-0">
              View our full menu offerings, including our signature ramen bowls,
              fresh sushi, and premium steaks.
            </p>
            <a
              href={MenuPdf}
              target="_blank"
          ...
          <div className="md:w-1/2 w-full">
            <div className="relative max-w-md mx-auto">
              ...
              <button
                onClick={scrollPrev}
                className="absolute top-1/2 left-4 -translate-y-1/2 rounded-full p-2 transition-colors z-10 hover:bg-white/80"
              ...
              <button
                onClick={scrollNext}
                className="absolute top-1/2 right-4 -translate-y-1/2 rounded-full p-2 transition-colors z-10 hover:bg-white/80"
                style={{ background: "rgba(42,42,42,0.6)", color: "#fff" }}
              >
                <ArrowRight size={24} />
              </button>
    ...
    >
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <button
            onClick={scrollPrev}
            className="absolute top-1/2 left-4 -translate-y-1/2 rounded-full p-2 transition-colors z-10"
          ...
          <button
            onClick={scrollNext}
            className="absolute top-1/2 right-4 -translate-y-1/2 rounded-full p-2 transition-colors z-10"
            style={{ background: "rgba(42,42,42,0.7)", color: "#fff" }}
          >
            <ArrowRight size={24} />
          </button>
...
const GOOGLE_FORM_ACTION_URL =
  "https://docs.google.com/forms/d/e/1FAIpQLSepCn3vz8tqQMn1hEPSH1bhzdFRWlC5mXChKBvPL42fuW0BDQ/formResponse";
...
const ContactSection = () => {
  ...
  return (
    <section
      id="contact"
      className="py-20 md:py-32"
      style={{ background: BG_LIGHT, color: TEXT_COLOR }}
    >
      <div className="container mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-1/2 w-full">
            ...
            <div className="h-64 lg:h-80 w-full rounded-lg overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d16048.609309176636!2d120.53960883928916!3d15.150817302925121!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3396f3ce9aaccd9f%3A0x2ffd59ee507506b5!2sOsaka%20Japanese%20Restaurant!5e1!3m2!1sen!2sph"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen=""
